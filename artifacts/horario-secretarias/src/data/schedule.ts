...
export const COURSE_COLORS: Record<string, string> = {
  ...
  'M1 INT': 'bg-blue-200 text-blue-900 border-blue-300',
  'M2': 'bg-indigo-100 text-indigo-800 border-indigo-200',
  'M2 INT': 'bg-indigo-200 text-indigo-900 border-indigo-300',
  'MT': 'bg-violet-100 text-violet-800 border-violet-200',
  'MS': 'bg-purple-100 text-purple-800 border-purple-200',
  'MP': 'bg-fuchsia-100 text-fuchsia-800 border-fuchsia-200',
  'FIS': 'bg-emerald-100 text-emerald-800 border-emerald-200',
  'FIS INT': 'bg-emerald-200 text-emerald-900 border-emerald-300',
  'BIO': 'bg-green-100 text-green-800 border-green-200',
  'BIO INT': 'bg-green-200 text-green-900 border-green-300',
  'QUI': 'bg-teal-100 text-teal-800 border-teal-200',
  'QUI INT': 'bg-teal-200 text-teal-900 border-teal-300',
  'LN': 'bg-orange-100 text-orange-800 border-orange-200',
  'LN INT': 'bg-orange-200 text-orange-900 border-orange-300',
  'LT': 'bg-amber-100 text-amber-800 border-amber-200',
  'LS': 'bg-yellow-100 text-yellow-800 border-yellow-200',
  'LP': 'bg-lime-100 text-lime-800 border-lime-200',
  'HS': 'bg-red-100 text-red-800 border-red-200',
  'HS INT': 'bg-red-200 text-red-900 border-red-300',
  'CS': 'bg-rose-100 text-rose-800 border-rose-200',
};
